...
const AI_BRIEFING_FILE_RE = /^content\/ai-briefings\/(\d{4}-\d{2}-\d{2})-ai-briefing\.md$/;
const INVESTMENT_BRIEFING_FILE_RE = /^content\/investment-briefings\/(\d{4}-\d{2}-\d{2})-investment-briefing\.md$/;
