# Investment Daily Briefing And Column Implementation Plan

> Steps use checkbox (`- [ ]`) syntax for progress tracking.

**Goal:** 为博客新增独立的 `投资` 内容域、投资每日简报发布链路、公开 coverage 说明页，以及配套的 `investment-daily-briefing` skill。
...
- Create: `app/investment/daily-briefings/page.tsx`
- Create: `app/investment/daily-briefings/archive/page.tsx`
- Create: `app/investment/daily-briefings/archive/[year]/[month]/page.tsx`
- Create: `app/investment/daily-briefings/[date]/page.tsx`
...
- Create: `skills/investment-daily-briefing/SKILL.md`
- Create: `skills/investment-daily-briefing/README.md`
- Create: `skills/investment-daily-briefing/references/source-map.md`
- Create: `skills/investment-daily-briefing/references/event-map.md`
- Create: `skills/investment-daily-briefing/evals/evals.json`
- Create: `.opencode/skills/investment-daily-briefing/SKILL.md`
- Create: `.opencode/skills/investment-daily-briefing/README.md`
- Create: `.opencode/skills/investment-daily-briefing/references/source-map.md`
- Create: `.opencode/skills/investment-daily-briefing/references/event-map.md`
- Create: `.opencode/skills/investment-daily-briefing/evals/evals.json`
...
Create `/investment/daily-briefings` using the AI list-page pattern, but adapt the wording and empty state for investment content.
...
- `/investment/daily-briefings/archive`
- `/investment/daily-briefings/archive/[year]/[month]`
...
`app/investment/daily-briefings/[date]/page.tsx` must:
...
- Create: `skills/investment-daily-briefing/references/event-map.md`
- Create: `skills/investment-daily-briefing/evals/evals.json`
- Create: `.opencode/skills/investment-daily-briefing/*`
- Create: `tests/skills/investment-skill-sync.test.ts`
...
Copy the same files into `.opencode/skills/investment-daily-briefing/`.
...
it("keeps mirrored skill files in sync", () => {
  expect(readFileSync("skills/investment-daily-briefing/SKILL.md", "utf8")).toBe(
    readFileSync(".opencode/skills/investment-daily-briefing/SKILL.md", "utf8"),
  );
});
```
