...
> 只用于维护 `LLM 之家` 专栏。默认优先访问官方发布页、官方 pricing 页和官方开发文档。

## OpenAI

- 官方新闻：`https://openai.com/news/`
...
- 官方新闻：`https://www.anthropic.com/news`
- 官方价格页：`https://claude.com/pricing#api`
- 官方模型文档：`https://platform.claude.com/docs/en/about-claude/models/overview`
- 官方 release notes：`https://platform.claude.com/docs/en/release-notes/overview`

## Google / Gemini

- 官方博客：`https://blog.google/innovation-and-ai/models-and-research/google-deepmind/`
...
- 官方 Hugging Face：`https://huggingface.co/deepseek-ai`

## 月之暗面 / Kimi

- 官方博客：`https://www.kimi.com/blog/`
- 官方模型列表：`https://platform.kimi.com/docs/models.md`
- 官方价格页目录：`https://platform.kimi.com/docs/pricing/`
...
- 官方发布日志：`https://docs.bigmodel.cn/cn/update/new-releases.md`
- 官方模型文档目录：`https://docs.bigmodel.cn/cn/guide/models/text/`
