...
export interface BriefingRecommendChatStreamOptions extends BaseAIChatStreamOptions {
  scene: "briefing-recommend";
  context: { range: "today" | "3d" | "7d" | "14d" | "30d" };
  onEvent: (event: RecommendStreamEvent) => void;
}

export interface InvestmentBriefingRecommendChatStreamOptions extends BaseAIChatStreamOptions {
