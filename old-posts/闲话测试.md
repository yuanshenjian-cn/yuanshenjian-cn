...
<!-- 这是一张图片，ocr 内容为：$$$ UI SERVICE UNIT -->
![](https://cdn.nlark.com/yuque/0/2023/png/104324/1673358885827-4ac98eed-1e00-4f0a-bb4d-9064535c1a7f.png)

<font style="color:#8A8F8D;">图片源自：</font>[<font style="color:#8A8F8D;">https://martinfowler.com/bliki/TestPyramid.html</font>](https://martinfowler.com/bliki/TestPyramid.html)
...
<!-- 这是一张图片，ocr 内容为：MANUAL THE PRACTICAL TEST PYRAMID IN -->
![](https://cdn.nlark.com/yuque/0/2023/png/104324/1673359525258-e1e6abd0-108f-455a-9dcb-64e0c4dcfe10.png)

<font style="color:#8A8F8D;">图片源自：</font>[<font style="color:#8A8F8D;">https://martinfowler.com/articles/practical-test-pyramid.html</font>](https://martinfowler.com/articles/practical-test-pyramid.html)
...
老马还发明了一个跟上述命名不在一个维度上的名字 -- **宽栈测试**（BroadStackTest），<font style="background-color:#FDFDFD;">宽栈测试通常也被称为 端到端测试</font>**<font style="background-color:#FDFDFD;"> </font>**<font style="background-color:#FDFDFD;">或 全栈测试。这个名字也很形象，宽嘛，涵盖范围大，但明确的边界呢，也是没有的。</font>
...
<!-- 这是一张图片，ocr 内容为：面向业务 自动化 手动 手动 用户验收测试 功能测试 探索性测试 故事测试 易用性测试 原型 模拟 支撑团队 评价产品 Q2 Q3 QI Q4 组件测试 性能测试 单元测试 安全测试 自动化 工具 面向技术 -->
![](https://cdn.nlark.com/yuque/0/2023/png/104324/1674204391950-561ba44c-4cb0-4f89-ba56-4f28c387c6ab.png)



# 为了好日子
[测试金字塔实战](https://www.yuque.com/yuanshenjian/agile/practical-test-pyramid)<font style="color:rgb(51, 51, 51);"> 的作者 Ham 是德国 Thoughtworks 的一名软件开发和咨询师。由于厌倦了在凌晨 3 点手动部署软件，他开始持续交付实践，加紧自动化步伐，并着手帮助团队高效可靠地交付高质量软件。这样他就可以把省出来的时间用在别的有趣的事情上了。</font>

<font style="color:rgb(51, 51, 51);"></font>

<font style="color:rgb(51, 51, 51);">如果你也希望跟 Ham 一样，可以有更多的时间做一些有趣的事情，如果你还想落地好 </font>[主干开发](https://docs.google.com/presentation/d/1nI20qe4a-OzP18bkgPJet3we4Qfs8bhYH6RKi1lu9ZE/edit#slide=id.g12afdfe59b5_0_89)<font style="color:rgb(51, 51, 51);">。我诚恳地建议你：多了解一些行业中测试相关的理论以及落地实践，如果你非要问我为什么，我认为前者是为了方便交流，后者则是为了将来的好日子。</font>
...
+ [Mocks 不是 Stubs](https://www.yuque.com/yuanshenjian/agile/mocks-are-not-stubs)
