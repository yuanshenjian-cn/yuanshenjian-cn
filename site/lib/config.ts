...
const HOMEPAGE_RECOMMEND_TURNSTILE_TIMEOUT_MS = 60000;
const ARTICLE_PAGE_ASSISTANT_TURNSTILE_TIMEOUT_MS = 60000;
const AUTHOR_PAGE_ASSISTANT_TURNSTILE_TIMEOUT_MS = 60000;
const CONTEXTUAL_ADVISOR_TURNSTILE_TIMEOUT_MS = 60000;
const DEFAULT_CONTEXTUAL_ADVISOR_HISTORY_ROUNDS = 20;
...
const coreServiceUrl = (process.env.NEXT_PUBLIC_CORE_SERVICE_URL || "").replace(/\/$/, "");
