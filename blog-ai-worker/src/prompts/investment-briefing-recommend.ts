...
export const INVESTMENT_BRIEFING_RECOMMEND_REFERENCE_DELIMITER = "<<<INVESTMENT_BRIEFING_RECOMMEND_REFERENCES>>>";
...
export function buildInvestmentBriefingRecommendStreamSystemPrompt(briefings: RecommendReference[]): string {
