---
title: 2026-08-27 AI 简报：OpenAI 复盘 HF 安全事件并扩展课堂 AI；Google 发转写与血糖基础模型
date: "2026-08-27"
published: true
brief: 本期聚焦 4 件官方动态：OpenAI 发布 Hugging Face 安全事件官方复盘并扩大 ChatGPT for Teachers 覆盖；Google 推出 Gemini 3.5 Transcribe 转写模型与 GlucoFM 连续血糖监测基础模型。
tags:
  - AI
  - OpenAI
  - Google
