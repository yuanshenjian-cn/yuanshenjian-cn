...
同日，1134 名来自 OpenAI、Anthropic、Google、Meta、Microsoft 等前沿 AI 实验室的员工联合签署"Pacing the Frontier"公开信。信中指出，AI 可能即将实现自动化 AI 研究。他们请求美国政府支持国际合作，开发"有意识调控前沿 AI 开发速度"的技术和治理工具。
...
Hugging Face 安全事件的余波在本期集中释放。最值得关注的不是某一家公司的应对。整个行业正在形成的共识是——前沿 AI 的发展可能确实需要更审慎的节奏。
