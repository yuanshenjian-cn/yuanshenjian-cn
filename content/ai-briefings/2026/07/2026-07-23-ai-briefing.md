...
Google 以三款新模型延续了 Flash 系列的快速迭代节奏，3.6 Flash 在编码和研究基准上的跃升说明模型能力提升远未放缓。AMD 对 Anthropic 的投资方式——芯片供应与资金捆绑——预示着 AI 算力供应正在从通用的云租赁模式转向锁定式基础设施合作。美国政府对月之暗面的制裁威胁叠加此前的中芯/华为受限事件，表明中美 AI 竞赛正在从模型能力层面延伸至供应链与知识产权的双重管制。OpenAI Presence 则标志着 Agent 在企业级市场的部署正从实验走向平台化。四条主线合在一起，本周 AI 竞争的轮廓已比特朗普 AI 行政令时期更加清晰：技术迭代、资本绑定、地缘规制与企业部署四条线同步加速，任何一条的边际变化都可能牵动后续格局。
