...
![image](/images/xp/testing/cdct.webp)
...
![image](/images/xp/testing/spring-cloud-contract.webp)
...
![image](/images/xp/testing/testpyamid-evolution.webp)

引入了CDCT并摆出了正确的姿势，便可大大弱化UI测试，甚至可以使用少量的人工测试来代替自动化UI测试。CDCT帮助我们缓解了UI测试的痛点，但也要当心走极端，譬如有些团队的测试策略发生了下面的极端情况：

![image](/images/xp/testing/testpyramid-bad-evolution.webp)
