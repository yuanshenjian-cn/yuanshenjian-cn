...
![](/images/xp/tdd/parking-boy-state.webp)
...
![](/images/xp/tdd/parking-boy-behavior.webp)

## 触及进程边界

"够简单对吧，整一个稍微复杂的场景，给你加点难度，我把写好的测试代码特意删除了，你来用两种方式实现一下。" 袁帅边说边打开了类图：

![](/images/xp/tdd/ci-monitor-arch.webp)
...
![](/images/xp/tdd/jdbc-mock-verification.webp)
