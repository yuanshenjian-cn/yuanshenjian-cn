...
date: '2017-04-02'
brief: >-
  RAML是一门API描述语言，支持设计、构建、测试、文档化和分享API。本文介绍如何使用RAML构建RESTful API，通过"共享图书馆"案例展示了User增删改查的API设计方法。使用RAML to HTML生成API文档，osprey-mock-service搭建Mock Server，通过Docker容器化实现构建与数据分离。RAML结合Docker能有效管理微服务架构下的API契约，提升前后端分离开发效率。
...
![image](/images/api/raml-api-page.webp)
