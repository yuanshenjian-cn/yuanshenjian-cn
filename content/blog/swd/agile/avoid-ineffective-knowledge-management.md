...
published: true
brief: >-
  探讨软件开发团队中的知识管理问题，区分显性知识、隐性知识和不可言说知识三类。文章指出团队常陷入企图用显性知识管理方式处理不可言说知识的陷阱，强调有效的知识管理需要通过社交活动如结对编程、Code Review等来传递不可言说的知识，形成生产-传递-运用-吸收的完整知识消费闭环。
---
...
![有效知识从生产到吸收的消费闭环](/images/swd/agile/knowledge-cycle-1.webp)
...
![软件延期主要原因的数据图](/images/swd/agile/knowledge-delay-reasons.webp)
...
![Kick Off 到 Review 的知识传递闭环](/images/swd/agile/knowledge-cycle-2.webp)
