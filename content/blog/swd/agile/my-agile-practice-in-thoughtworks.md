...
published: true
brief: >-
  分享在ThoughtWorks参与海外独立交付项目的敏捷实践经验。文章详细介绍了IPM、Standup、Story Kick Off、Pair、TDD、Code Review、Showcase、CI、Retro等敏捷实践，阐述如何通过高效协作与快速反馈实现项目成功交付，并强调敏捷不只是流程形式，更要追求实践背后的真正价值。
---
...
![团队 workout 运动文化照片](/images/swd/agile/agile-workout.webp)
...
![敏捷迭代活动流程图](/images/swd/agile/agile-iteration-flow.webp)
...
![Mingle 上的迭代需求看板](/images/swd/agile/agile-mingle-board.webp)
...
![团队每日站会现场](/images/swd/agile/agile-standup.webp)
...
![结对进行 Story Kick Off 的现场](/images/swd/agile/agile-story-kickoff.webp)
...
![结对编程工作现场](/images/swd/agile/agile-pair-programming.webp)
...
![团队 Code Review 讨论现场](/images/swd/agile/agile-code-review.webp)
...
![持续集成 Dashboard 截图](/images/swd/agile/agile-ci-dashboard.webp)
...
![团队 Retro 回顾会议现场](/images/swd/agile/agile-retro.webp)
