---
title: "Kimi：月之暗面这条线最特别的地方，是 Agent 味越来越重"
date: '2026-08-17'
tags:
  - AI前沿
  - LLM
...
<small>*数据来源：Kimi 官方平台文档、官方 pricing 页面、官方博客与官方资源页，查询日期 2026-08-17。Kimi K3 的发布日期 2026-07-16 与定价 $0.30/$3.00/$15.00（缓存命中/未命中输入/输出，约合 ¥2/¥20/¥100）来自 K3 发布博客。Kimi K2.7 Code 的官方发布日期 2026-06-25 来自官方资源页（kimi.com/resources/kimi-k2-7-code）标注的“8 min read 2026-06-25”。官方模型列表另列有 `kimi-k2.7-code-highspeed`，输出速度约 180 tokens/s（短上下文可达 260 tokens/s），定价与 K2.7 Code 一致，属于同一型号的 speed 变体。K2 系列（kimi-k2、kimi-k2-0905-preview、kimi-k2-0711-preview 等）已于 2026-05-25 下线；官方模型列表同时提示 `kimi-k2.5` 与 `moonshot-v1` 系列将于 2026-08-31 全平台下线。若官方博客页未直接给发布日期，则明确写“官方页面未直接标注”。*</small>
...
**2026-08-17 更新：** 官方模型列表新增了 `kimi-k2.7-code-highspeed`。它不是独立的新一代，而是 K2.7 Code 的高速变体：官方标称输出速度约 180 tokens/s，短上下文场景可达 260 tokens/s。定价与标准版 K2.7 Code 一致（输入 ¥6.50/1M、缓存命中 ¥1.30/1M、输出 ¥27.00/1M），因此不单独列入顶部总表，只作为 K2.7 Code 的运行模式补充记录。
