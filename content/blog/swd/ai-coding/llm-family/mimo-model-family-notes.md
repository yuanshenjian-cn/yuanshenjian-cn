---
title: "小米 MiMo：这条线值得关注，不只是因为国产新玩家"
date: '2026-09-23'
tags:
  - AI前沿
  - LLM
...
published: true
brief: >-
  这是一份按代际持续维护的小米 MiMo 模型档案，现覆盖 MiMo-V2.6-Pro、MiMo-V2.6-Flash、MiMo-V2.5-Pro、MiMo-V2.5、MiMo-V2、MiMo-V2-Flash 和 MiMo-7B 系列，重点记录官方发布时间、能力、Agent 长任务特征与价格，后续只追加新模型信息。
---
...
|------|-------------|---------|---------|---------|------------------|
| MiMo-V2.6-Pro | 官方页面未直接标注 | ¥3.00 / 百万 | ¥0.025 / 百万 | ¥6.00 / 百万 | 全模态旗舰，面向专业、长程、复杂工作流，也覆盖科研与网络安全 |
| MiMo-V2.6-Flash | 官方页面未直接标注 | ¥1.00 / 百万 | ¥0.02 / 百万 | ¥2.00 / 百万 | 全模态高效型号，面向高频调用与规模化任务 |
| MiMo-V2.5-Pro | 2026-04-22 | ¥3.00 / 百万 | ¥0.025 / 百万 | ¥6.00 / 百万 | 1M context、42B active、明显冲长程 Agent 与复杂软件工程；新增 UltraSpeed 变体 |
| MiMo-V2.5 | 2026-04-22 | ¥1.00 / 百万 | ¥0.02 / 百万 | ¥2.00 / 百万 | omnimodal 主线模型，1M context，往通用多模态 Agent 走 |
| MiMo-V2 | 2026-03-18 | 官方未公布 | 官方未公布 | 官方未公布 | V2 系列通用主线，承上启下（2026-06-30 已下线，转发至 V2.5 系列） |
| MiMo-V2-Flash | 2025-12 | ¥0.70 / 百万 | ¥0.07 / 百万 | ¥2.10 / 百万 | 309B 轻量 MoE，强调速度与 Agentic workflow（2026-06-30 已下线，转发至 V2.5 系列） |
| MiMo-7B 系列 | 2025-05-12（论文公开）/ 2025-05-30（RL-0530） | 官方未公布 | 官方未公布 | 官方未公布 | 7B 小模型 reasoning 线，适合看这家训练路线的早期风格 |

<small>*数据来源：Xiaomi MiMo 开放平台定价页、MiMo 官方站点、官方 Hugging Face、官方 GitHub 与官方论文页面。既有数据首次查询日期为 2026-08-17，本次查询日期为 2026-09-23。MiMo-V2.6-Pro 与 MiMo-V2.6-Flash 的官方模型页面未直接标注发布日期；当前价格分别为输入 ¥3.00 / ¥1.00、缓存命中 ¥0.025 / ¥0.02、输出 ¥6.00 / ¥2.00 每百万 token。MiMo-V2.5-Pro 与 MiMo-V2.5 价格已按官方当前定价页更新为统一价（不再按 256K 分界分档），相比 2026-06-28 记录的价格大幅下降。官方同时提供 MiMo-V2.5-Pro-UltraSpeed 内测申请：输入 ¥9.00/百万（缓存未命中）、¥0.075/百万（缓存命中），输出 ¥18.00/百万，官方标称峰值速度 1000 tokens/s。MiMo-V2 与 MiMo-7B 系列在当前官方定价页中未列出模型级输入/缓存/输出单价，因此按“官方未公布”处理。据官方开放平台公告，MiMo-V2 系列模型已于 2026-06-30 正式下线，原模型名称失效并转发至 V2.5 系列。*</small>

## MiMo-V2.6：用 Pro 与 Flash 拉开旗舰和高频档位

小米为 MiMo-V2.6 提供 Pro 与 Flash 两个 API 型号。两者都支持文本、图像、视频和音频输入，最大上下文为 1M token，最大输出为 128K token。[Pro 官方页](https://mimo.mi.com/models/zh-CN/mimo-v2.6-pro)把它定位为面向长程复杂任务的全模态旗舰，覆盖专业工作、科研和网络安全；[Flash 官方页](https://mimo.mi.com/models/zh-CN/mimo-v2.6-flash)则面向高频调用与规模化任务。

按官方当前人民币 API 价格，Pro 的输入、缓存命中和输出分别为 ¥3、¥0.025、¥6 / 百万 token；Flash 分别为 ¥1、¥0.02、¥2。两者的模型页都没有直接给出发布日期，所以总表保留了日期缺口，没有根据页面出现时间推算。
...
**2026-08-17 更新：** 官方定价页当前把 V2.5-Pro 价格统一为输入 ¥3.00/百万、缓存命中 ¥0.025/百万、输出 ¥6.00/百万，不再按上下文长度分档，整体比 2026-06-28 记录的价格低了很多。同时官方开放了 MiMo-V2.5-Pro-UltraSpeed 内测：输入 ¥9.00/百万（缓存未命中）、¥0.075/百万（缓存命中），输出 ¥18.00/百万，标称峰值速度 1000 tokens/s。UltraSpeed 是同一 V2.5-Pro 模型上的速度优化变体，不是独立新代，因此不单独列入顶部总表。
...
- MiMo-V2.6-Pro: `https://mimo.mi.com/models/zh-CN/mimo-v2.6-pro`
- MiMo-V2.6-Flash: `https://mimo.mi.com/models/zh-CN/mimo-v2.6-flash`
