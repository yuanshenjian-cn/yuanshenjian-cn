...
<small>*数据来源：Xiaomi MiMo 开放平台定价页、MiMo 官方站点、官方 Hugging Face、官方 GitHub 与官方论文页面，查询日期 2026-08-17。MiMo-V2.5-Pro 与 MiMo-V2.5 价格已按官方当前定价页更新为统一价（不再按 256K 分界分档），相比 2026-06-28 记录的价格大幅下降。官方同时提供 MiMo-V2.5-Pro-UltraSpeed 内测申请：输入 ¥9.00/百万（缓存未命中）、¥0.075/百万（缓存命中），输出 ¥18.00/百万，官方标称峰值速度 1000 tokens/s。MiMo-V2 与 MiMo-7B 系列在当前官方定价页中未列出模型级输入/缓存/输出单价，因此按“官方未公布”处理。据官方开放平台公告，MiMo-V2 系列模型已于 2026-06-30 正式下线，原模型名称失效并转发至 V2.5 系列。*</small>
