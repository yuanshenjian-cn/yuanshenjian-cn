...
> **前置阅读**：本篇假设你已熟悉[第四篇](/articles/2026/04/07/claude-code-interactive-mode-and-built-in-commands)中介绍的六种权限模式（Default / AcceptEdits / Plan / Auto / DontAsk / BypassPermissions），这里将深入权限*规则*层面而非模式层面。
