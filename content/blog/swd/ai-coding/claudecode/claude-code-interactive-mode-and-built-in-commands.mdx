...
> **系列导读**：本文是 Claude Code 系列第 4 篇。第 1 篇讲[迁移心智模型](/articles/2026/04/07/opencode-to-claude-code-getting-oriented)，第 2 篇讲[安装与上手](/articles/2026/04/07/claude-code-getting-started)，第 3 篇讲[日常工作流](/articles/2026/04/07/claude-code-common-workflows)。本篇将深入交互层——权限模式、命令体系与上下文管理，让你从"能用"进阶到"用得顺"。
