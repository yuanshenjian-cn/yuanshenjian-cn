...
在上一篇 [Agent 完全指南](/blog/swd/ai-coding/opencode/oh-my-opencode-agents-guides) 中，我们介绍了 Oh My OpenCode 的 11 个 AI Agent。本文将深入探讨 **Categories（类别）系统**——这是 Oh My OpenCode 任务委派机制的核心，决定了不同类型任务应该使用什么模型和配置。
